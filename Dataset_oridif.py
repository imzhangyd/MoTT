...
class cls_Dataset_oridif(Dataset):
    def __init__(self,txtfile,datamean=None,datastd=None):
        super(cls_Dataset_oridif,self).__init__()
        ...
        for linenum,line in enumerate(lines):
            try:
                # obtain passed and t_future list from line
                line = line.strip('\n')
                line = line.rstrip()
...
def func_getdataloader_oridif(txtfile, batch_size, shuffle, num_workers,mean=None,std=None):
    dtst_ins = cls_Dataset_oridif(txtfile,mean,std)
