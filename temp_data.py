    ...
    def __init__(self, one_frame_match_list, mean_=None, std_=None):
        ...
        for line in one_frame_match_list:
            ...
            passed_shift = np.concatenate(
                [passed_shift, augpassed_pre[:, :-1], flag_np], -1
            )
            ...
            datapathlist.append(
                [passed_shift, future_shift_np, trackid, cand5_id, passed]
            )
...
def func_getdataloader_oridif_match(
    txtfile, batch_size, shuffle, num_workers, mean=None, std=None
):
