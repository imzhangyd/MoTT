...
metric_root = "/mnt/data1/ZYDdata/code/MoTT_particle_notsame/MoTT/prediction"

allmetric_filepathlist = glob.glob(os.path.join(metric_root, "**FN_baseline"))
print(allmetric_filepathlist)
columnsname = [
    "method",
    "FN_rate",
...
for tkrepa in allmetric_filepathlist:
    ...
    for onemetricfile in allthismethod_testmetrics:
        ...
        keeprate = alllines[10].strip().split(": ")[1]
        adict["FN_rate"] = keeprate
        ...
        testname = ref_name
        with open(os.path.join(onemetricfile, "relink_result.txt"), "r") as Fi:
...
pres_df.to_csv("./merge_baseline_hold2_metrics.csv")
